...
class _CreatePollScreenState extends State<CreatePollScreen> {
  ...
  void _submitForm(BuildContext context) {
    if (_formKey.currentState!.validate()) {
      ...
      // You can now send jsonData to your backend or use it as needed

      // Save the election
      Provider.of<ElectionViewModel>(context, listen: false).saveElection(
          accessToken!,
          election); // Replace accessToken with your actual access token
    }
  }
}
